...
public class TestNgAnnotations {
	  ...
	  public void v() {
		  ExtentHtmlReporter htmlreporter=new ExtentHtmlReporter("demo.html");
			
			ExtentReports extent=new ExtentReports();
			extent.attachReporter(htmlreporter);
   ExtentTest test=extent.createTest("Testing the logs");
   test.log(Status.PASS, "This method has passed the execution");
   extent.flush();
		  System.out.println("@Test annotation");
	  }
	  @Test
